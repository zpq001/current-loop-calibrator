...
#ifndef __MDR32F9x_CONFIG_H
#define __MDR32F9x_CONFIG_H
...
//#define USE_MDR1986VE9x   - moved to project settings
...
/**
  ...
  *   which gets the source file ID (see MDR32F9x_lib.h), line number and
